...
@Tag(name = "Fichiers Commentaire Projet", description = "API de gestion des fichiers liés aux commentaires de projets")
public class FichierCommentaireProjetController {
    ...
    @Operation(
            ...
            description = "Permet d'uploader un ou plusieurs fichiers pour un commentaire de projet spécifique"
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Fichiers uploadés avec succès"),
            @ApiResponse(responseCode = "400", description = "Données invalides"),
            @ApiResponse(responseCode = "404", description = "Commentaire de projet non trouvé")
    })
    @PostMapping("/upload")
    public ResponseEntity<?> uploadFiles(
            @Parameter(description = "ID du commentaire de projet", example = "1")
    ...
    @Operation(
            summary = "Supprimer tous les fichiers d'un commentaire de projet",
            description = "Supprime tous les fichiers associés à un commentaire de projet"
    )
    @ApiResponses(value = {
    ...
    @Operation(
            summary = "Lister tous les fichiers d'un commentaire de projet",
            description = "Retourne la liste de tous les fichiers associés à un commentaire de projet"
    )
    @ApiResponses(value = {
